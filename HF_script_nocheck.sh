...
# wget --no-check-certificate https://gitlab.com/J-C-B/community-splunk-scripts/-/raw/master/hwf-splunk-centos8.sh
...
# Install tools
yum install nano wget --no-check-certificate tcpdump firewalld -y
...
cd $tmp_dir_path
wget --no-check-certificate -O 99-splunk.conf 'https://vegalayer.com/splunk/configs/99-splunk.conf'
...
# Disable THP at boot
cd $tmp_dir_path
wget --no-check-certificate -O disable-thp.service 'https://vegalayer.com/splunk/configs/disable-thp.service'
...
#wget --no-check-certificate -O splunk-7.2.5.1-962d9a8e1586-Linux-x86_64.tgz 'https://www.splunk.com/bin/splunk/DownloadActivityServlet?architecture=x86_64&platform=linux&version=7.2.5.1&product=splunk&filename=splunk-7.2.5.1-962d9a8e1586-Linux-x86_64.tgz&wget --no-check-certificate=true'
#wget --no-check-certificate -O splunk-7.3.0-657388c7a488-Linux-x86_64.tgz 'https://www.splunk.com/bin/splunk/DownloadActivityServlet?architecture=x86_64&platform=linux&version=7.3.0&product=splunk&filename=splunk-7.3.0-657388c7a488-Linux-x86_64.tgz&wget --no-check-certificate=true'
#wget --no-check-certificate -O splunk-8.0.3-a6754d8441bf-Linux-x86_64.tgz 'https://www.splunk.com/bin/splunk/DownloadActivityServlet?architecture=x86_64&platform=linux&version=8.0.3&product=splunk&filename=splunk-8.0.3-a6754d8441bf-Linux-x86_64.tgz&wget --no-check-certificate=true'
#wget --no-check-certificate -O splunk-8.0.6-152fb4b2bb96-Linux-x86_64.tgz 'https://www.splunk.com/bin/splunk/DownloadActivityServlet?architecture=x86_64&platform=linux&version=8.0.6&product=splunk&filename=splunk-8.0.6-152fb4b2bb96-Linux-x86_64.tgz&wget --no-check-certificate=true'



wget --no-check-certificate -O splunk-8.1.0-f57c09e87251-Linux-x86_64.tgz 'https://www.splunk.com/bin/splunk/DownloadActivityServlet?architecture=x86_64&platform=linux&version=8.1.0&product=splunk&filename=splunk-8.1.0-f57c09e87251-Linux-x86_64.tgz&wget --no-check-certificate=true'
